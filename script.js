function Total(){
  ...
  if(sub1>100 || sub2>100 || sub3>100 || sub4>100 || sub5>100 )
  {
    ...
    document.getElementById("total").innerHTML = "Programing In Java Marks :"+sub1+"<br> Web Development Project Marks: "+sub2+"<br> Sequential Logic System Marks: "+sub3+"<br> Accounting Theory And Practice Marks: "+sub4+"<br> Operating System Application Marks: "+sub5+"<br> Total Marks: "+total;  
  }
}
function Average(){
  var sub1 = parseInt(document.getElementById("eng").value);
